...
static unsigned int default_efficient_freq_hp[] = {1670400, 2054400};
static u64 default_up_delay_hp[] = {30 * NSEC_PER_MSEC, 470 * NSEC_PER_MSEC};

static unsigned int default_efficient_freq_pr[] = {2073600, 2457600};
static u64 default_up_delay_pr[] = {30 * NSEC_PER_MSEC, 470 * NSEC_PER_MSEC};
